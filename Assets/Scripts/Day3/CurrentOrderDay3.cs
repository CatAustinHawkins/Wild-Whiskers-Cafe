...
public class CurrentOrderDay3 : MonoBehaviour
{
    ...
    public Sprite FerretOrderBB; //order 1
    public Sprite KangarooOrderMS; //order 2
    public Sprite KangarooOrderMB; //order 3
    public Sprite ChimpOrderSAS;
    public Sprite ChimpOrderFS;
    public Sprite BeaverOrderSH;
    ...
    public void Clicked() //UIBook Button
    {
        ...
        if (!OrderOpen) //if the order form is not currently open
        {
            ...
            {
                OrderForm.sprite = FerretOrderBB;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
            }
            if (Player.CurrentOrder == 2)
            {
                OrderForm.sprite = KangarooOrderMS;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
            ...
            {
                OrderForm.sprite = KangarooOrderMB;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
            }
            if (Player.CurrentOrder == 4)
            {
                OrderForm.sprite = ChimpOrderSAS;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
            }
            if (Player.CurrentOrder == 5)
            {
                OrderForm.sprite = ChimpOrderFS;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
            ...
            {
                OrderForm.sprite = BeaverOrderSH;  //activate the relevant order form
                Order.SetActive(true);
                OrderOpen = true; //set order open to true
