...
public class Customers : MonoBehaviour
{
    ...
    public bool CustomerMealTime; //for other scripts to read
    ...
    IEnumerator Mealtimer() //To control when customers are sat at a table and then can be fed
    {
        yield return new WaitForSecondsRealtime(7.5f);
        CustomerMealTime = true;
    }
}
