...
public class PlayerMove : MonoBehaviour
{
    ...
    public bool MovementKeyboard = true;

    //player can choose between movement using keybaord WASD or using the mouse
    //Mouse will be enabled by default on mobile builds 
