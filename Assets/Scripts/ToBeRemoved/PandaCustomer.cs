...
public class PandaCustomer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DialogueScript.PandaDrink1 = true;
    ...
    void Update()
    {
        ...
        if(movingtofoh) //if the player is moving to the front of house
        {
            ...
            if (!MovingtoDesk) //if the player isnt moving to the desk
            {
    ...
    public void FedSmoothie() //if the customer has been fed
    {
        ...
        DialogueScript.PandaDrink1 = false; //disable panda drink bool, as the panda has been served
    ...
    IEnumerator Eating1() //first eating coroutine
    {
        ...
        DialogueScript.PandaMeal1 = true; //set panda meal 1 to true
