...
/// 1 Meal
/// </summary>
public class RaccoonCustomer : MonoBehaviour
{
    ...
    public GameObject ClamMisoSoup; //REPLACE WITH FOOD

    public GameObject Coins; //coins

    public Dialogue DialogueScript; //dialogue script

    public GameObject AlpacaCustomer; //REPLACE WITH SPAWNED CUSTOMER
    ...
    {
        ClamMisoSoup.SetActive(true);
        StartCoroutine(Eating2());
        DialogueScript.RaccoonMeal = false;
        DialogueScript.RaccoonDone = true;
        DialogueScript.AlpacaDrink = true;
    }
    ...
    IEnumerator AlpacaSpawn()
    {
        yield return new WaitForSeconds(30f);
        AlpacaCustomer.SetActive(true);
    }
}
