...
/// 2 Meals
/// </summary>
public class ChimpCustomer : MonoBehaviour
{
    ...
    public GameObject BeaverCustomer; //REPLACE WITH SPAWNED CUSTOMER
    ...
    public void FedSmoothie()
    {
        ...
        DialogueScript.ChimpDrink = false;
    }
    ...
    public void FedMeal() //if the customer has been fed
    {
        ...
        DialogueScript.ChimpMeal = false;
        DialogueScript.ChimpDone = true;
        DialogueScript.AbletoTalk = true;
    }
    ...
    IEnumerator Eating1()
    {
        ...
        DialogueScript.ThoughtIcons[15].SetActive(true); //the FOOD icon
        DialogueScript.ThinkBubble[9].SetActive(true); //thought bubble
        DialogueScript.ChimpMeal = true;
