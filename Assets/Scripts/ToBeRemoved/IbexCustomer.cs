...
/// 1 Meal
/// </summary>
public class IbexCustomer : MonoBehaviour
{
    ...
    public GameObject DuckCustomer; //REPLACE WITH SPAWNED CUSTOMER

    public AudioSource PlateDrop;
    public AudioSource AnimalEating;

    public GameObject ChipmunkCustomer;
    ...
    IEnumerator CustomerLeaving() //waiting at the front of house desk - then they can move to the table
    {
        ...
        ChipmunkCustomer.SetActive(true);
    }
    ...
    public void FedMeal() //if the customer has been fed
    {
        ...
        DialogueScript.IbexMeal = false;
        DialogueScript.IbexDone = true;
        DialogueScript.DuckMeal = true;
        DialogueScript.AbletoTalk = true;
    }
