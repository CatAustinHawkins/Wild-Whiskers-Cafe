...
/// 1 Meal
/// </summary>
public class BeaverCustomer : MonoBehaviour
{
    ...
    public GameObject StickHotdog; //REPLACE WITH FOOD
    ...
    void Start()
    {
        ...
        DialogueScript.BeaverMeal = true;
    }
    ...
    void Update()
    {
        ...
        if (movingtofoh) //if the player is moving to the front of house
        {
            ...
            if (!MovingtoDesk && !FerretCustomer.activeSelf)
            {
    ...
    {
        StickHotdog.SetActive(true);
        StartCoroutine(Eating2());
        DialogueScript.BeaverMeal = false;
    }
    ...
    IEnumerator Eating2() //second eating coroutine
    {
        ...
        DialogueScript.BeaverDone = true;
    }
}
