...
//Day 5 Alpaca
//2 Meals
public class AlpacaCustomer : MonoBehaviour
{
    ...
    public GameObject FoxCustomer; //REPLACE WITH SPAWNED CUSTOMER
    ...
    public void FedSmoothie()
    {
        ...
        DialogueScript.AlpacaDrink = false;
    }
    ...
    public void FedMeal() //if the customer has been fed
    {
        ...
        DialogueScript.AlpacaMeal = false;
        DialogueScript.AlpacaDone = true;
        DialogueScript.FoxMeal = true;
    }
    ...
    IEnumerator Eating1()
    {
        ...
        DialogueScript.ThoughtIcons[29].SetActive(true); //the FOOD icon
        DialogueScript.ThinkBubble[19].SetActive(true); //thought bubble
        DialogueScript.AlpacaMeal = true;
