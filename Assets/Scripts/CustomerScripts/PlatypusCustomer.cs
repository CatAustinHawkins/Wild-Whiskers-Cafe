...
/// 1 Meal
/// </summary>
public class PlatypusCustomer : MonoBehaviour
{
    ...
    public GameObject CrayfishTempura; //REPLACE WITH FOOD

    public GameObject Coins; //coins

    public Dialogue DialogueScript; //dialogue script

    public GameObject BatCustomer; //REPLACE WITH SPAWNED CUSTOMER

    public AudioSource PlateDrop;
    public AudioSource AnimalEating;

    public GameObject FoxCustomer;
    void Start()
    {
        ...
        DialogueScript.PlatypusMeal = true;
    }
    ...
    {
        CrayfishTempura.SetActive(true);
        StartCoroutine(Eating2());
        DialogueScript.PlatypusMeal = false;
        DialogueScript.PlatypusDone = true;
        DialogueScript.BatDrink = true;
    }
