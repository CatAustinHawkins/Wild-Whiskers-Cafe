...
/// 1 Meal
/// </summary>
public class DuckCustomer : MonoBehaviour
{
    ...
    public GameObject PangolinCustomer; //REPLACE WITH SPAWNED CUSTOMER
    ...
    {
        Escargot.SetActive(true);
        StartCoroutine(Eating2());
        DialogueScript.DuckMeal = false;
        DialogueScript.DuckDone = true;
        DialogueScript.PangolinDrink = true;
    }
