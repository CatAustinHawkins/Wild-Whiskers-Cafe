...
public class Interact : MonoBehaviour
{
    ...
    public PandaCustomerDay5 PandaDay5CustomerScript;
    ...
    public void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (other.tag == "PandaDay5Customer")
        {
            PandaDay5InRange = true;
        }
    ...
    public void InteractButton()
    {
        ...
        if (OvenInRange && !OnFire)
        {
           ...
           if(StickCooked || MossCooked || MelonCooked || MeatCooked || CrayfishCooked || ClamCooked || AntCooked || BambooCooked && PlayerRightHandFull)
           {
            ...
            if (AntandSpaghettiCooked && !PlayerRightHandFull && !OnFire)
            {
                OvenOn = false;
                CookedAntandSpaghetti.SetActive(true);
                OvenInteractPrompt.SetActive(false);
                AntandSpaghettiReady = true;
        ...
        if (LeopardInRange)
        {
            if (MeatSmoothieMade)
            {
                ...
                LeopardCustomerScript.FedSmoothie();
                MeatSmoothieMade = false;
                PlayerLeftHandFull = false;
            }

            if (VenisonSteakReady || VenisonSteakPrepared)
            {
                VenisonSteak.SetActive(false);
                LeopardCustomerScript.FedMeal();
                VenisonSteakPrepared = false;
        ...
        if (PonyInRange)
        {
            if (StrawberryandAppleSmoothieMade)
            {
                StrawberryandAppleSmoothie.SetActive(false);
                PonyCustomerScript.FedSmoothie();
        ...
        if (HedgehogInRange)
        {
            if (AntSmoothieMade)
            {
                ...
                HedgehogCustomerScript.FedSmoothie();
                AntSmoothieMade = false;
                PlayerLeftHandFull = false;
            }

            if (WormSpaghettiReady)
            {
                WormSpaghetti.SetActive(false);
                HedgehogCustomerScript.FedMeal();
        ...
        if (KangarooInRange)
        {
            if (MelonSmoothieMade)
            {
                MelonSmoothie.SetActive(false);
                KangarooCustomerScript.FedSmoothie();
            ...
            if (MossBurgerReady)
            {
                ...
                KangarooCustomerScript.FedMeal();
        ...
        if (ChimpInRange)
        {
            ...
            {
                StrawberryandAppleSmoothie.SetActive(false);
                ChimpCustomerScript.FedSmoothie();
                StrawberryandAppleSmoothieMade = false;
                PlayerLeftHandFull = false;
                PlayerRightHandFull = false;
            }
        ...
        if (GemsbokInRange)
        {
            ...
            {
                MelonSmoothie.SetActive(false);
                GemsbokCustomerScript.FedSmoothie();
                MelonSmoothieMade = false;
                PlayerLeftHandFull = false;
            }
        ...
        if (PangolinInRange)
        {
            ...
            {
                AntSmoothie.SetActive(false);
                PangolinCustomerScript.FedSmoothie();
                AntSmoothieMade = false;
                PlayerLeftHandFull = false;
            }

            if (AntandSpaghettiReady)
            {
                AntandSpaghettiReady = false;
                AntCooked = false;
                SpaghettiCooked = false;
                AntCooking = false;
                CookedAntandSpaghetti.SetActive(false);
                AntPasta.SetActive(false);
                PangolinCustomerScript.FedMeal();
                AntPastaReady = false;
                PlayerLeftHandFull = false;
                PlayerRightHandFull = false;
            }
        ...
        if (ChipmunkInRange)
        {
            if (MushroomsCooked)
            {
                CookedMushrooms.SetActive(false);
                ChipmunkCustomerScript.FedMeal();
        ...
        if (PlatypusInRange)
        {
            if (CrayfishTempuraReady)
            {
                CrayfishTempura.SetActive(false);
                PlatypusCustomerScript.FedMeal();
        ...
        if (RaccoonInRange)
        {
            if (ClamMisoSoupReady)
            {
                ClamMisoSoup.SetActive(false);
                RaccoonCustomerScript.FedMeal();
        ...
        if (AlpacaInRange)
        {
            ...
            {
                StrawberryandAppleSmoothie.SetActive(false);
                AlpacaCustomerScript.FedSmoothie();
                StrawberryandAppleSmoothieMade = false;
                PlayerLeftHandFull = false;
            }
        ...
        if (PandaDay5InRange)
        {
            ...
            {
                BambooHotdog.SetActive(false); //disable the bamboo hotdog
                PandaDay5CustomerScript.FedMeal();//call to the customer script
                BambooHotdogReady = false;
                PlayerRightHandFull = false;
                PlayerLeftHandFull = false;
            }
            ...
            if (MeatSmoothieMade && !AlreadyFed) //when the meal is cooked
            {
                AlreadyFed = true;
                MeatSmoothie.SetActive(false); //disable the bamboo hotdog
                PandaDay5CustomerScript.FedSmoothie();//call to the customer script
                MeatSmoothieMade = false;
                PlayerLeftHandFull = false;
            }
        }
        ...
        if (BedInRange)
        {
            ...
            if(Day1 && DialogueScript.LeopardDone)
            {
                Day1End.SetActive(true);
            }

            if (Day2 && DialogueScript.GiraffeDone)
            {
                Day2End.SetActive(true);
            }

            if (Day3 && DialogueScript.BeaverDone)
            {
                Day3End.SetActive(true);
            }

            if (Day4 && DialogueScript.ChipmunkDone)
            {
                Day5End.SetActive(true);
            }

            if (Day5 && DialogueScript.PandaDone)
            {
                Day5End.SetActive(true);
            }
        }
        ...
        if (TrashBininRange)
        {
            ...
            TrashTimerValue = TrashTimerValue + 0.25f;
    ...
    IEnumerator OvenTimer()
    {
        ...
        if(OvenTimerValue > 1 && AntCooking && SpaghettiCooking)
        {
    ...
    {
        TrashTimerValue = TrashTimerValue + 0.000005f;
        TrashTimerSlider.value = TrashTimerValue;
        yield return new WaitForSeconds(0.25f);
        StartCoroutine(TrashSliderTimer());
    ...
    public void ChoppingBoardPopUpTick()
    {
        ...
        if (MeatCooked && FridgeScript.HoldingBread)
        {
            CookedMeat.SetActive(false);
            FridgeScript.HoldingBread = false;
            HoldingBreadGO.SetActive(false);
            MeatCooked = false;
            MouseBurgerChopping = true;
        }
